    ...
    <form method="GET" action="" class="mb-4 pt-5">
        <div class="row justify-content-center text-center">
            <div class="col-2 d-flex flex-column align-items-center">
                ...
                <input type="text" class="form-control mb-2" id="min_cost" name="min_price" value="<?php echo htmlspecialchars($_GET['min_price'] ?? '') ?>">
            </div>
            <div class="col-2 d-flex flex-column align-items-center">
            ...
            <div class="col-10 d-flex flex-column align-items-center">
                ...
                <label class="text-black mt-2">Фильтрация по бренду:</label>
                <select name='brand' class='form-control'>
                    <option value='' selected> Выберите бренд</option>
                    <?php
                    foreach ($GLOBALS['brands_names'] as $item) {
                        echo "<option value='{$item['id_brand']}' ";
                        if (isset($_GET['brand']) && $_GET['brand'] == "{$item['id_brand']}") {
                            echo "selected";
                        }
                        echo ">{$item['name_brand']}</option>";
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="row justify-content-center mt-3">
            ...
            <button type="submit" value="Reset" name="reset" class="btn btn-danger mx-2 btn-sm">Сбросить фильтры</button>
        </div>
    </form>
</div>
