        ...
        <div class="container">
            <div class="row ms-4 mt-2">
                ...
                <div class="col info_bar">
                        ...
                        <div class="row mt-4">
                            <p>К сожалению, данный товар закончился. Давайте подберём альтернативный вариант<br> в этой же <span class="underline">категории товаров</span>.</p>
                        </div>
            ...
            <div class="row mt-5 consult">
                <div class="col consult-col d-flex flex-column align-items-center">
                        ...
                        <p class="">Вся команда нашего магазина увлекается активными видами спорта: туризмом, альпинизмом, горными лыжами и другими<br> видами outdoor-активности</p>
                ...
                <div class="col ps-5 consult-col d-flex flex-column align-items-center">
                        ...
                        <p class="">Коротко о самом важном: новых коллекциях<br> и брендах, о снаряжении и как его выбрать, ближайших акциях и распродажах</p>
